...
- **`happiness` is a computed getter** (not a stored stat). Factors: job (+5/-3), resources (critical <10: -5, low <30: -2, comfortable ≥70: +3), relationship (+3), age (<18: -1, >65: -3), illness (−round(illness×5)). Floor 0.
