...
- `docs/model-reference.md` — add a design-decision bullet for ARD 042 and update the `Simulation.kill()` description on the implementation surface; `docs/odd-protocol.md` §7 — add the estate-distribution submodel.
