...
- `docs/odd-protocol.md` — add the `StatDecayEvent` submodel to §7; update the `ExerciseEvent`, `LearnEvent` and `GraduationEvent` submodels to note caps; update the §3 event order for the new jail path.
